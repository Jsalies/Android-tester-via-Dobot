...
class Interface():
    ...
    def __init__(self):
        ...
        self.txt1 = Label(self.fenetre, text='caractéristiques du téléphone :', fg="white",
                          font=("Helvetica", 10, "bold italic"), bg="black")
        self.txt2 = Label(self.fenetre, text='instructions :', fg="white", font=("Helvetica", 10, "bold italic"),
                          bg="black")
        self.txt3 = Label(self.fenetre, text='Largueur (en Pixels) :', fg="white", anchor='e',
                          font=("Helvetica", 10, "bold"), bg="black")
        self.txt4 = Label(self.fenetre, text='Hauteur (en Pixels) :', fg="white", anchor='e',
                          font=("Helvetica", 10, "bold"), bg="black")
        self.txt5 = Label(self.fenetre, text='nombre de test :', fg="white", anchor='e', font=("Helvetica", 10, "bold"),
                          bg="black")
        self.txt6 = Label(self.fenetre, text='choix du scénario :', fg="white", font=("Helvetica", 10, "bold italic"),
                          bg="black")
        self.txt7 = Label(self.fenetre, text='mesure d\'energie :', fg="white", font=("Helvetica", 10, "bold italic"),
                          bg="black")
        ...
        self.instruction = Label(self.fenetre, textvariable=self.TexteInstructions, bg='gray', justify="left",
        ...
        self.aide = Button(self.fenetre, image=self.HelpPicture, bg='black', command=helpMe, overrelief=FLAT,
                           borderwidth="0p", highlightthickness="1p")
        ...
        # definition du bouton AIDE
        self.graphiques = Button(self.fenetre, text='GRAPHIQUE', bg='#797DF6', font=("ms serif", 10, "bold"),
                                 command=graphique)
        # placement du bouton AIDE
        ...
        self.synthese = Button(self.fenetre, text='SYNTHESE', bg='#797DF6', font=("ms serif", 10, "bold"),
                               command=synthese)
        # placement du bouton AIDE
        ...
        self.toutfaire = Checkbutton(self.fenetre, variable=self.tousScenarios, text="Tout tester", bg="gray",
        ...
        self.PowerTranMethode = Checkbutton(self.fenetre, variable=self.PowerTran, text="PowerTran Methode", bg="gray",
                                            activebackground="gray")
        ...
        # on defini notre zone de texte
        self.MesureEnergie = Label(self.fenetre, textvariable=self.TexteMesureEnergie, justify="left", bg='gray',
                                   relief='sunken', anchor='nw')
        ...
        self.txt9 = Label(self.fenetre, text='frequence :', fg="black", font=("Helvetica", 10, "bold italic"),
                          bg="gray")
        ...
        self.pourcentaffichage = Label(self.fenetre, textvariable=self.pourcentafficher, bg='black', fg="white",
        ...
        self.monimage = PIL.Image.open(
            "./ressources/pictures/progressbar.bmp")  ## Chargement d'une image à partir de PIL
        ...
        self.calibrage = Button(self.fenetre, text='Calibrage inclinaison téléphone', bg='#797DF6',
                                font=("ms serif", 8, "bold"), command=calibrer)
        # placement du bouton LANCER
