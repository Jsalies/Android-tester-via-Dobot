...
class Interface():
    ...
    def __init__(self):
        ...
        self.Nbscenar = Spinbox(self.fenetre, from_=0, to=500,bg="gray")
        ...
        self.instruction=Label(self.fenetre,textvariable=self.TexteInstructions,bg='gray',relief='sunken',anchor='nw')
        ...
        self.pourcentaffichage.place(height=30,width=30,x=710,y=528)
        ...
        def Init():
            ...
            thread1=test2.Afficheur(self,L,H,Nb,Scenar)
            thread1.start()
    ...
    def setpourcent(self,value):
        if (value>=0 and value<=100):
            self.pourcent=value
            self.pourcentafficher.set(str(value))
            boost()
            return
        elif(value<0):
            self.pourcent=0
